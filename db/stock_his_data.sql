...
create table stock_his_data(
  ...
  t_open decimal(8, 2) comment '开盘价',
  t_close  decimal(8, 2) comment '收盘价',
  t_high decimal(8, 2) comment '最高价',
  t_low decimal(8, 2) comment '最低价',
  ...
  market_flag int(1) comment '股票交易标志(1:正常    0:停牌)',
