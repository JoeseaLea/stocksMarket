...
public interface StockHisDataService {
     ...
     * @return 指定数量的股票历史数据
     */
    List<StockHisDataVo> getStockHisData(StockVo stockVo, int marketFlag, int size);
     ...
     */
    List<StockHisDataVo> getStockHisData(StockVo stockVo, int marketFlag, int startIndex, int size);
}
